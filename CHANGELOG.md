...
### 1.7.0-RC2 ###
* :star: Add `Database::discard_unselected_events()` to drop undelivered events of selected classes on demand, e.g. from a disconnect handler. Opt-in and lossy by design. See [#427](https://github.com/stepfunc/dnp3/issues/427).
