...
mod tests {
    ...
    fn can_write_integrity() {
        ...
        assert_eq!(
            ...
            [
                // g1v2 - s/s == 0, restart
                1, 2, 0x01, 0, 0, 0, 0, 0x02, // g20v1 - s/s == 1, restart, value == 0
                20, 1, 0x01, 1, 0, 1, 0, 0x02, 0, 0, 0, 0,
                // g30v1 - s/s == 2, restart, value == 0
                30, 1, 0x01, 2, 0, 2, 0, 0x02, 0, 0, 0, 0,
            ]
        )
    }
