...
impl<'a> RangedVariation<'a> {
    ...
    pub fn log(&self, level: log::Level) {
        match self {
            ...
            RangedVariation::Group40Var1(seq) => log_items(level, seq.iter()),
            RangedVariation::Group40Var2(seq) => log_items(level, seq.iter()),
            RangedVariation::Group40Var3(seq) => log_items(level, seq.iter()),
