...
import dev.gridio.dnp3.codegen.model.{Base10, EnumModel, EnumValue, EnumValues}

object DefaultVariations {

  private def create(name: String, values: List[EnumValue]): EnumModel = model.EnumModel(name, Nil, EnumModel.UInt8, values, None, Base10)
