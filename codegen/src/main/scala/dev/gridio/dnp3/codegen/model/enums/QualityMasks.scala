...
object QualityMasks {
  ...
  def enums: List[EnumModel] = List(
    model.EnumModel("BinaryQuality", comments("binary"), EnumModel.UInt8, binaryValues, None, Hex),
    model.EnumModel("DoubleBitBinaryQuality", comments("double bit binary"), EnumModel.UInt8, doubleBinaryValues, None, Hex),
    model.EnumModel("CounterQuality", comments("counter"), EnumModel.UInt8, counterValues, None, Hex),
    model.EnumModel("FrozenCounterQuality", comments("frozen counter"), EnumModel.UInt8, frozenCounterValues, None, Hex),
    model.EnumModel("AnalogQuality", comments("analog"), EnumModel.UInt8, analogValues, None, Hex),
    model.EnumModel("BinaryOutputStatusQuality", comments("binary output status"), EnumModel.UInt8, binaryOutputValues, None, Hex),
    model.EnumModel("AnalogOutputStatusQuality", comments("analog output status"), EnumModel.UInt8, analogOutputValues, None, Hex)
  )
