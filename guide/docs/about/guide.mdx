...
Please note that while this guide covers some DNP3 concepts, it doesn't replicate the DNP3 standard itself. If you plan to develop a product that uses DNP3, a copy of the standard is indispensable. Purchase you copy from [DNP3 Users Group](https://dnp.org) or [IEEE](https://standards.ieee.org/standard/1815-2012.html). 
