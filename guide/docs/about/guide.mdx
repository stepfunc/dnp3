...
While this guide covers many DNP3 concepts, it doesn't replicate the DNP3 standard itself. If you plan to develop a product that uses DNP3, a copy of the
