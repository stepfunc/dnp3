...
The standard may be purchased from the [DNP3 Users Group](https://dnp.org) or [IEEE](https://standards.ieee.org/standard/1815-2012.html). If you plan to develop
or deploy a product that uses DNP3, a copy of the standard will be indispensable. We recommend that you join the user group to obtain a copy of the standard as
this provides access to a wealth of additional documents and a forum.
