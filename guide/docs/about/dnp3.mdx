...
Outstations are also frequently used to transfer measurement and control data from a utility SCADA system to a historian or 3rd party system. These applications are
