...
`Complicense` produces a verbose report called [licenses.txt](https://github.com/stepfunc/dnp3/blob/master/ffi/licenses.txt) that aggregates the following information for each license:
