---
id: bindings
title: Rust and Bindings
sidebar_label: Rust and Bindings
slug: /bindings
---
...
We use an internally developed binding generator we call [oo_bindgen](https://github.com/stepfunc/oo_bindgen/) to produce idiomatic bindings for each target
