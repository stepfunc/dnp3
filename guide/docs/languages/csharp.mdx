...
The C# bindings are distributed as a [Nuget package](https://www.nuget.org/packages/dnp3rs) and uses [P/Invoke](https://docs.microsoft.com/en-us/dotnet/standard/native-interop/pinvoke)
