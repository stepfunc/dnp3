...
:::note
The **LogLevel** should be set to **Info** by default. This will result in messages at the Info, Warn, and
Error level being logged. The Debug and Trace levels are generally only useful if debugging an issue with the underlying runtime.
