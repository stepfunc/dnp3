...
Creating an outstation bound to a serial port is done using the `Outstation::createSerialSession` method. In addition to the common components, this method takes
