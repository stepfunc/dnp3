...
```rust
{{#include ../examples/outstation/src/main.rs:tls_ca_chain_config}}

{{#include ../examples/outstation/src/main.rs:create_tls_server}}
```
...
```rust
{{#include ../examples/outstation/src/main.rs:tls_self_signed_config}}
