...
```rust
{{#include ../examples/master/src/main.rs:tls_ca_chain_config}}

{{#include ../examples/master/src/main.rs:create_master_tls_channel}}
```
...
```rust
{{#include ../examples/master/src/main.rs:tls_self_signed_config}}
